...
2360 PRINT "WARP FACTOR (0-";X$;")";:INPUTW1:IF D(1)<0ANDW1>.2 THEN 2470
...
5150 FOR I=1 TO 3:IF X3=K(I,1)ANDY3=K(I,2) THEN 5190
5180 NEXT I:I=3
...
7850 PRINT:PRINTO1$:NEXT I:PRINT:GOTO 1990
