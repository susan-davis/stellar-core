...
1040 G(I,J)=K3*100+B3*10+FN R(1):NEXT J:NEXT I:IF K9>T9 THEN T9=K9+1
...
2910 R1=FN R(1):IF RND(1)>=.6 THEN 3000
...
6360 END
6370 PRINT "CONGRULATIONS, CAPTAIN! THE LAST KLINGON BATTLE CRUISER"
...
8590 R1=FN R(1):R2=FN R(1):A$="   ":Z1=R1:Z2=R2:GOSUB 8830:IF Z3=0 THEN 8590
8600 RETURN
...
8790 ONR1GOTO 8792,8794,8796,8798,8800,8802,8804,8806
...
9120 ONZ4GOTO 9130,9140,9150,9160,9170,9180,9190,9200
